...
#a = floor(r[1,])#floor(runif(1, min = 1, max = 500)) #creates shifting prior for AncSize

#write(sprintf("AncestralSize=%i", a),
#      "/home/guy/splatche3/template/template_input.txt",
#      append = T
#      )
    #appends the sprintf txt to the bottom of the file 

b = r[1,]#runif(1, min = 0, max = 0.5) #creates shifting prior for MigraRate, P1
...
c = r[2,]#runif(1, min = 0, max = 0.5) #creates shifting prior for MigraRate, P2
...
d = r[3,]#runif(1, min = 0, max = 0.7) #creates shifting prior for adm P1 to P2
...
e = r[4,]#runif(1, min = 0, max = 0.7) #creates shifting prior for adm P2 to P1
...
f = r[5,]#runif(1, min = 0, max = 0.7) #creates shifting growth P1

write(sprintf("GrowthRate=%f", e),
      "/home/guy/splatche3/template/template_input.txt",
      append = T
)

g = r[6,]#runif(1, min = 0, max = 0.7) #creates shifting growth P2
